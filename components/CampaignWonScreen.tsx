...
interface CampaignWonScreenProps {
    score: number;
    onRestart: () => void;
}

export const CampaignWonScreen: React.FC<CampaignWonScreenProps> = ({ score, onRestart }) => {
    return (
        <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center text-center z-10 p-4">
            <h2 className="text-6xl font-bold text-yellow-400 mb-4 animate-pulse">VICTORY</h2>
            <p className="text-2xl text-gray-300 mb-2">You have saved the galaxy!</p>
